...
class StringReverseStringSolution implements StringReverseStringSolutionInterface
{
     ...
     */
    public function runReverseStringSolution(
        StringType $input,
        $algorithm = null
    ): ?StringReturner {
        $this->algorithm =
            AlgorithmFactory::getInstance()->setAlgorithm(
                AlgorithmType::getInstance()
                    ->setAlgorithm(
                        StringType::getInstance()->setValue(
                            $algorithm === null
        ...
        return StringReturner::getInstance()->setValue(
